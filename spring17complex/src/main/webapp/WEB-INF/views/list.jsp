...
<form method="get" autocomplete="off" class="search-form">
	...
	<br><br>
	가격 : <input type="text" name="minPrice" value="${param.minPrice}"> 
				~ <input type="text" name="maxPrice" value="${param.maxPrice}">
	<br><br>
	제조일 : <input type="text" name="beginMade" value="${param.beginMade}"> 
				~ <input type="text" name="endMade" value="${param.endMade}">
	<br><br>
